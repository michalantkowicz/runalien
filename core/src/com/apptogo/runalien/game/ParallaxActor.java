...
public class ParallaxActor extends Actor {
	...
	//DODAC MOZLIWOSC USTAWIANIA PREDKOSCI W ZALEZNOSCI OD PREDKOSCI KAMERY!
	float speedX = 0.0001f, speedY;
	 ...
	 * scrolling from beggining. Other way we increment coordinates
