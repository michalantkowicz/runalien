...
//		});
        ...
        if (!(this instanceof TutorialScreen)) {
            ...
            sign.addActor(Image.get("board").scale(1 / UnitConverter.PPM));
    ...
    protected void step(float delta) {
        ...
        if (endGame) {
            ...
            gameworldStage.addAction(Actions.sequence(Actions.moveBy(0, UnitConverter.toBox2dUnits(-850), 2.5f, Interpolation.pow5), Actions.moveBy(0, UnitConverter.toBox2dUnits(-30), 60)));

            backgroundStage.addAction(Actions.sequence(Actions.moveBy(0, -850, 2.5f, Interpolation.pow5), Actions.moveBy(0, -30, 60)));

            middleBackgroundStage.addAction(Actions.sequence(Actions.moveBy(0, -850, 2.5f, Interpolation.pow5), Actions.moveBy(0, -30, 60)));

            stage.addAction(Actions.sequence(Actions.moveBy(0, -850, 2.5f, Interpolation.pow5), Actions.moveBy(0, -30, 60)));
            ...
            if (score > Gdx.app.getPreferences("SETTINGS").getLong("TOPSCORE")) {
                ...
                submitButton.addAction(
                        Actions.forever(Actions.sequence(Actions.moveBy(0, 15, 0.05f), Actions.moveBy(0, -30, 0.05f), Actions.moveBy(0, 15, 0.5f, Interpolation.elasticOut), Actions.delay(1))));
            }
