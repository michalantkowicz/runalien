...
public abstract class BasicScreen implements Screen {
    ...
    public BasicScreen(Main game, GameEventService eventService) {
        this.game = game;
        this.eventService = eventService;
    }

    public BasicScreen(Main game, GameEventService eventService, String backgroundTextureName) {
        this(game, eventService);
        this.backgroundTextureNames = new String[]{backgroundTextureName};
    }

//    public BasicScreen(Main game, GameEventService eventService, String[] backgroundTextureNames) {
//        this.game = game;
