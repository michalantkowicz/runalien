...
public class AnimationActor extends Actor {
    ...
    protected com.badlogic.gdx.graphics.g2d.Animation<AtlasRegion> animation;
    ...
    public AnimationActor(float frameDuration, Array<AtlasRegion> keyFrames) {
        this(frameDuration, keyFrames, PlayMode.NORMAL);
    }

    public AnimationActor(float frameDuration, Array<AtlasRegion> keyFrames, PlayMode playMode) {
